    ...
    <div className="app">
      ...
      <main className="pad" style={{ paddingTop: 18 }}>
        ...
        <div style={{ marginTop: 34, textAlign: 'center' }}>
          <button className="ghost u" onClick={() => setAboutOpen(true)}>만든 사람</button>
        </div>
      </main>
      ...
      <div style={{ marginTop: 30 }}>
        ...
        {TEAWARE.map((t) => (
          <div className="card" key={t.id}>
            ...
            <p className="body wrap-safe" style={{ marginTop: 6 }}>{t.body}</p>
          </div>
        ))}
  ...
  return (
    <Overlay onClose={onClose} align="center">
      <div style={{ textAlign: 'center' }}>
        ...
        <div className="h2" style={{ marginBottom: 16 }}>만든 사람</div>
        <p className="body wrap-safe" style={{ marginBottom: 8 }}>
        ...
        <div style={{ display: 'grid', gap: 8, textAlign: 'center' }}>
          <a className="btn-glass" href="mailto:emma.neway@gmail.com">emma.neway@gmail.com</a>
          <a className="btn-glass" href="https://instagram.com/emma.neway" target="_blank" rel="noreferrer">
            instagram.com/emma.neway
          </a>
        </div>
        <button className="ghost" style={{ width: '100%', marginTop: 14 }} onClick={onClose}>닫기</button>
      </div>
    </Overlay>
  )
}
...
function BrandMark({ size = 32 }) {
  return (
    <img className="brand-mark" width={size} height={size} alt="픽티업"
      src={`${import.meta.env.BASE_URL}illustrations/logo.jpg`} />
  )
}
