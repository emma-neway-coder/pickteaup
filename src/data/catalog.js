...
export const CATEGORIES = [
  { key: 'green',  name: '녹차',        vessel: '얕은 사발',  blurb: '맑고 서늘한 첫 페이지.' },
  { key: 'oolong', name: '청차 · 우롱차', vessel: '작은 잔',   blurb: '가벼움과 묵직함 사이, 발효도의 스펙트럼.' },
  { key: 'puer',   name: '보이차',       vessel: '자사호 잔',  blurb: '시간이 쌓여 부드러워진 것.' },
  { key: 'black',  name: '홍차',         vessel: '유럽식 잔',  blurb: '붉게 우러나는, 가장 익숙한 입구.' },
  { key: 'flower', name: '꽃차',         vessel: '유리 다관',  blurb: '처음 보는 것이 우러나는 순간.' },
]
